...
export const categories: Category[] = [
  ...
  { id: 'cat-5', name: 'Băng keo & Keo dán', slug: 'bang-keo', icon: '🔗', description: 'Băng keo trong, keo dán, keo sữa', productCount: 18, image: 'https://images.unsplash.com/photo-1589939705384-5185137a7f0f?w=400' },
  { id: 'cat-6', name: 'Dụng cụ văn phòng', slug: 'dung-cu-van-phong', icon: '🖇️', description: 'Máy bấm ghim, dao rọc giấy, thước kẻ', productCount: 35, image: 'https://images.unsplash.com/photo-1497366216548-37526070297c?w=400' },
  { id: 'cat-7', name: 'Mực in & Cartridge', slug: 'muc-in', icon: '🖨️', description: 'Mực in, cartridge, drum', productCount: 15, image: 'https://images.unsplash.com/photo-1612815154858-60aa4c59eaa6?w=400' },
